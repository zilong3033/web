...
<div id="comments" sytle="margin-bottom:100px">
...
function reply(a){
    ...
    var textArea=doucment.getElementById('newFormcontent');
    ...
    @foreach($page->hasManyComments as $comment)
        <div class="one" sytle="border-top:solid 20px #efefef;padding:5px 20px;">
